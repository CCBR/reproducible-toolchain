...
:::{.notes}
- Beyond Minimal Reproducibility: Code Quality
...
- streamline maintenance. fix a bug in the package, bump the version, and then every package that depends on it will have it.
:::
